...
public record TxnMetaCommand(
    ...
    public static TxnMetaCommand lifecycle(String txnId, long startTS,
                                           String lifecycleState,
                                           long expireAtMillis) {
        return new TxnMetaCommand(Type.LIFECYCLE, txnId, null, startTS, 0,
                -1, lifecycleState, expireAtMillis, Map.of());
    }
    ...
    public TxnMetaCommand withDecisionIndex(long index) {
        return new TxnMetaCommand(type, txnId, primary, startTS, commitTS,
                index, lifecycleState, expireAtMillis, regionMutations);
    }
}
