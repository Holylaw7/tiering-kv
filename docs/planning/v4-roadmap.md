...
| M4 | v4.0-GA | 生产收口 | Operator 完整化、多云部署深化、Jepsen 外部化分区注入、真实 Runner 性能基线（冷/热口径） | ADR-0322 | ✅ 阶段交付中（2026-08-14）：ADR-0322 + CapacityModel + benchmark.sh 真实入口；Operator/Jepsen/冷热基线进行中 |
