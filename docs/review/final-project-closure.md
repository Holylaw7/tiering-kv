...
已关闭：TD-001/005/006/007/008/009/010/011/012/013/014/016/017/018/
019/020/021/022…051（含 P3 收口新增）。

部分关闭（跟踪项，不阻塞）：TD-046/TD-049（真实容器级 disk 注入，
已有真实块设备闭环证据，容器级注入在后续维护期按需补充）。
